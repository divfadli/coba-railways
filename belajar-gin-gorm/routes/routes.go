...
func SetupRouter(db *gorm.DB) *gin.Engine {
	...
	moviesMiddlewareRoute.GET("/movies", controllers.GetAllMovie)
	moviesMiddlewareRoute.GET("/:id", controllers.GetMovieById)
	...
	ratingMiddlewareRoute.GET("", controllers.GetAllRating)
	ratingMiddlewareRoute.GET("/:id", controllers.GetRatingById)
	ratingMiddlewareRoute.GET("/:id/movies", controllers.GetMoviesByRatingId)
